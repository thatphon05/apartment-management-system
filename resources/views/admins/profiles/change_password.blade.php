...
@section('breadcrumb', Breadcrumbs::render('admin.change-password'))
@section('content')
        ...
        <div class="container-xl">
            <div class="container-xl">
                <div class="row">
                    <div class="col-12">
                        <div class="card mt-2">
                            <form action="{{ route('admin.profile.change-password.post') }}" method="post">
                                @csrf
                                <div class="card-body">
                                    <div class="col-md-3">
                                        <div class="mb-3">
                                            <label class="form-label required">รหัสผ่านเก่า</label>
