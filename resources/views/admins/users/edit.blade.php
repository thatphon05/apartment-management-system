                    ...
                    <div class="card-body">
                        <div class="row gx-4">
                                    ...
                                    <div class="col-md-12">
                                        <div class="mb-3 mt-1">
                                            ...
                                            <input value="{{ old('email') ?? $user->email }}" name="email" type="email"
                                                   ...
                                                   placeholder="อีเมล" disabled autocomplete="off">
                                            @error('email')
                                    ...
                                    <div class="col-sm-12 col-md-12">
                                        <div class="mb-2">
                                            ...
                                            <input value="{{ old('password') }}" name="password" type="password"
                                                   ...
                                                   placeholder="รหัสผ่านใหม่ (ไม่บังคับ)" autocomplete="off">
                                            @error('password')
                                            <div class="invalid-feedback">{{ $message }}</div> @enderror
                                        </div>
                                    </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <div class="row card-body">
                                    <div class="mb-3">
                                        @foreach(UserStatusEnum::values() as $key => $value)
                                            <label class="form-check form-check-inline">
                                                <input class="form-check-input"
                                                       type="radio"
                                                       name="status" value="{{ $key }}"
                                                    @checked(UserStatusEnum::from($key) === $user->status)
                                                >
                                                <span
                                                    class="form-check-label">
                                                    {{ UserStatusEnum::getLabel($value) }}
                                                </span>
                                            </label>
                                        @endforeach
                                    </div>
