                    ...
                    <div class="card">
                        <div class="card-body">
                            <form action="{{ route('admin.expenses.index') }}" method="get"
                                ...
                                @if (request()->has('month') || request()->has('year') || request()->has('room') )
                                    <a href="{{ route('admin.expenses.index') }}" class="btn btn-ghost-danger"
                        ...
                        <div class="table-responsive">
                            <table class="table card-table table-vcenter text-nowrap table-striped">
                                ...
                                <tr>
                                    <th>ประจำเดือน</th>
                                    <th>ห้อง</th>
                                    <th class="text-center">มิเตอร์น้ำ</th>
                                    <th class="text-center border-end">มิเตอร์ไฟ</th>
                                    <th class="text-center">หน่วยน้ำที่ใช้</th>
                                    <th class="text-center">หน่วยไฟที่ใช้</th>
                                    <th></th>
                                </tr>
                                </thead>
                                <tbody>
                                @forelse($expenses as $expense)
                                    <tr>
                                        <td><span>{{ $expense->cycle_month }}</span></td>
                                        <td>
                                            <span>
                                        ...
                                        <td class="text-center">
                                            <span>
                                                {{ number_format($expense->water_unit) }}
                                            </span>
                                        </td>
                                        <td class="border-end text-center">
                                            <span>
                                                {{ number_format($expense->electric_unit) }}
                                            </span>
                                        </td>
                                        <td class="text-center">
                                            <span>
                                                {{ number_format($expense->water_consumed) }}
                                            </span>
                                        </td>
                                        <td class="text-center">
                                            <span>
                                                {{ number_format($expense->electric_consumed) }}
                                            </span>
                                        </td>
                                        <td class="text-end">
