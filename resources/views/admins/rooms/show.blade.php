...
@section('title', 'รายละเอียดห้องพัก ' . $room->name)
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <object type="application/pdf"
                                                                data="{{ route('admin.booking.download.rent-contract', ['filename' => $currentBooking->rental_contract]) }}"
                                                                width="100%" height="500" style="height: 85vh;">
                                                            ระบบของคุณไม่สนับสนุนการเปิด
                                                            <a class="btn-link"
                                                               href="{{ route('admin.booking.download.rent-contract', ['filename' => $currentBooking->rental_contract]) }}">
                                                                ดาวน์โหลด
                                                            </a>
                                                        </object>
                                                    </div>
                            ...
                            <table class="table">
                                ...
                                @forelse($utilityExpenses as $utilityExpense)
                                    <tr>
                                        ...
                                        <td class="align-middle">
                                            {{ $utilityExpense->water_consumed }}
                                        </td>
                                        <td class="align-middle">
                                            {{ $utilityExpense->electric_consumed }}
                                        </td>
                                        <td class="align-middle">
