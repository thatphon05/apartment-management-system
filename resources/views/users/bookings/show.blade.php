...
@section('breadcrumb', Breadcrumbs::render('user.booking-show', $booking))
@section('content')
                                            ...
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-body">
                                                    <object type="application/pdf"
                                                            data="{{ route('user.booking.download-rent-contract', [
                                                                        'booking' => $booking->id,
                                                                  ]) }}"
                                                            width="100%" height="500" style="height: 85vh;">
                                                        ระบบของคุณไม่สนับสนุนการเปิด
                                                        <a class="btn-link"
                                                           href="{{ route('user.booking.download-rent-contract', [
                                                                        'booking' => $booking->id,
                                                                  ]) }}">
                                                            ดาวน์โหลด
                                                        </a>
